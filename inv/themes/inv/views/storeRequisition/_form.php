...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => $this->createUrl('storeRequisition/create'),
...
<div class="formDiv">
    <fieldset>
        <legend>Store Requisition Form</legend>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('storeRequisition/create', 'render' => true)), array(
                            'dataType' => 'json',
                            'type' => 'post',
                            'success' => 'function(data) {
                $("#ajaxLoader").hide();  
                    if(data.status=="success"){
                        ...
                        $.each(data, function(key, val) {
                            $("#store-requisition-form #"+key+"_em_").html(""+val+"");                                                    
                            $("#store-requisition-form #"+key+"_em_").show();
                        });
                    }       
                }',
                            'beforeSend' => 'function(){  
    ...
    $(document).ready(function(){
        ...
        $(".itms").click(function(){
            ...
            if($.inArray(itemsId, newArr) > -1){
                ...
                var positionOfArrVal=newArr.indexOf(itemsId);
                newQty+=parseFloat( ('0' + $("#qtyInpt_"+positionOfArrVal).val()).replace(/[^0-9-\.]/g, ''), 10 );
                   var noOfSack = $("#noOfSack_" + positionOfArrVal).val();
                var weghtPerSack = $("#weghtPerSack_" + positionOfArrVal).val();
...
//                $("#qtyInpt_"+positionOfArrVal).val(newQty);
    ...
    function add(itemsId, itemsName){
        ...
        var appendTxt = "<tr class='cartList'>"+
            ...
            itemsName +
             "</td><td>" +
            "<input style='text-align: center;' id='noOfSack_"+sl+"' myAttr1='qtyInpt_' myAttr2='"+sl+"' type='text' name='StoreRequisition[noOfSack][]' value='1'>"+
             "</td><td>" +
            "<input style='text-align: center;' id='weghtPerSack_"+sl+"' myAttr1='qtyInpt_' myAttr2='"+sl+"' type='text' name='StoreRequisition[weghtPerSack][]' value='1'>"+                 
            "</td><td>" +
        ...
        $('#noOfSack_' + count).bind('keyup', function () {
            var noOfSack = $('#noOfSack_' + count).val();
            var weghtPerSack = $('#weghtPerSack_' + count).val();
            var total = (noOfSack * weghtPerSack);
            $('#qtyInpt_' + count).val(total);
            $('#cashTotal').val($('input.lineTotalInpt').sumValues());
        });
        $('#weghtPerSack_' + count).bind('keyup', function () {
                 var noOfSack = $('#noOfSack_' + count).val();
            var weghtPerSack = $('#weghtPerSack_' + count).val();
            var total = (noOfSack * weghtPerSack);
            $('#qtyInpt_' + count).val(total);
