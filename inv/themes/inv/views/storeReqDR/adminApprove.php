...
//            ),
            ...
            array(
                'name' => 'req_id',
                'value' => 'StoreRequisition::model()->itemOfThis($data->req_id)',
            ...
            array(
                'name' => 'req_no',
                'header' => 'Approve',
                'value' => 'StoreReqDR::model()->approveAll($data->req_no)',
                'filter' => '',
            ),
        )
    ));
    ...
    $poData = StoreReqDR::model()->findAll(array('condition' => $condition,), 'id');
    if ($poData) {
        foreach ($poData as $pod):
            ...
            echo CHtml::ajax(array(
                'url' => array('storeReqDR/allApprove', 'sl_no' => $sl_no),
