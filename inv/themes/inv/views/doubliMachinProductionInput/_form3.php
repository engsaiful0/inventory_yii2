...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => $this->createUrl('DoubliMachinProductionInput/returnQty'),
            'enableAjaxValidation' => false,
            'enableClientValidation' => true,
            'clientOptions' => array('validateOnSubmit' => true),
        ));
?>
<?php $data = DoubliMachinProductionInput::model()->findAll(array("condition" => "sl_no='" . $sl_no . "'")); ?>
<div class="formDiv">
    <fieldset>
        <legend>Doubli Machin Production Input Return Qty Form</legend>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('DoubliMachinProductionInput/returnQty', 'sl_no' => end($data)->sl_no)), array(
                            'dataType' => 'json',
                            'type' => 'post',
