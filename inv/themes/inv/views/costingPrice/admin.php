...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('costing-price-grid', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<?php echo CHtml::link('Back', array('/items/adminAddCostingPrice'), array('class'=>'additionalBtn')); ?>
<fieldset style="float: left; width: 98%;">
    <legend>Manage Costing Prices</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'costing-price-grid',
