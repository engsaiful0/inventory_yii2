...
<div class="formDiv">
    <fieldset>
        ...
        <table>
            <tr>
                <td><?php echo $form->labelEx($model, 'sl_no'); ?></td>
                <td><div class="receivedByDiv"><?php echo $model->sl_no; ?></div></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'sl_no'); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo $form->labelEx($model, 'd_qty_kg'); ?></td>
                <td><?php echo $form->textField($model, 'd_qty_kg'); ?></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'd_qty_kg'); ?></td>                   
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo $form->labelEx($model, 'r_qty_kg'); ?></td>
                <td><?php echo $form->textField($model, 'r_qty_kg'); ?></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'r_qty_kg'); ?></td>                   
            </tr>
            <tr>
                <td><?php echo $form->labelEx($model, 'vehicle_type'); ?></td>
                <td><?php echo $form->textField($model, 'vehicle_type'); ?></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'vehicle_type'); ?></td>                   
            </tr>
            <tr>
                <td><?php echo $form->labelEx($model, 'vehicle_no'); ?></td>
                <td><?php echo $form->textField($model, 'vehicle_no'); ?></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'vehicle_no'); ?></td>                   
            </tr>
            <tr>
