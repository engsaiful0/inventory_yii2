    ...
    <fieldset>
        ...
        <table class="checkoutTab">
            ...
            foreach ($reqInfo as $soi): ?>
                <?php
                $totalReceivedQty = BasickSheetReqDR::model()->availableQtyOfThisReqId($soi->id);
                ...
                if ($remaining_receive_qty > 0) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $basickSheetStockInventory= BasickSheetInventory::model()->presentStockOfThisItemAllStore($soi->item);
                            echo $form->textField($model, 'stockQty[]', array('value' => $basickSheetStockInventory, 'id' => 'stockQty_' . $i, 'style' => 'text-align: center;'));
                            ?>
                        </td>
