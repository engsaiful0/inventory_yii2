...
<div class='printAllTableForThisReport'>
    <div class="grid-view">
        <table class="headerTab">
            ...
            <tr>
                <th colspan="2" style="text-align: center; text-decoration: underline; padding-bottom: 30px;">BASICK SHEET REQUISITION FORM</th>
            </tr>
            <tr>
        ...
        <table class="reportTab">
            ...
            <?php foreach ($data as $d) { ?>
                <tr class="<?php
                    ...
                    <td style="text-align: center;"><?php echo $d->width ?></td>
                    <td style="text-align: center;"><?php echo $d->height  ?></td>
                    <td style="text-align: center;"><?php echo $d->thickness  ?></td>
                    <td style="text-align: center;"><?php echo UnitDistance::model()->unit_of_distanceOfThis($d->unit_of_distance);  ?></td>
                    <td style="text-align: center;"><?php echo $d->qty; ?></td>
                     <td style="text-align: center;"><?php echo Units::model()->name_of_unitOfThis($d->unit_of_weight);  ?></td>
                </tr>
<?php } ?>
        </table>
        <table class="headerTab">
