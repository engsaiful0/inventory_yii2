<?php
$data = BasickSheetRequisition::model()->findAll(array("condition" => "sl_no='" . $sl_no . "'"));
if ($data) {
    ?>
    <?php
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'basick-sheet-requisition-form',
        'action' => $this->createUrl('basickSheetRequisition/update'),
        'enableAjaxValidation' => false,
        'enableClientValidation' => true,
        'clientOptions' => array('validateOnSubmit' => true),
    ));
    ?>
    <input type="hidden" name="BasickSheetRequisition[created_time]" value="<?php echo end($data)->created_time; ?>"/>
    <input type="hidden" name="BasickSheetRequisition[created_by]" value="<?php echo end($data)->created_by; ?>"/>
    <input type="hidden" name="BasickSheetRequisition[sl_no]" value="<?php echo end($data)->sl_no; ?>"/>
    <input type="hidden" name="BasickSheetRequisition[max_sl_no]" value="<?php echo end($data)->max_sl_no; ?>"/>
    <div class="formDiv">
        <fieldset>
            <legend>Basic Sheet Requisition Update Form</legend>
            <div class="scrollable">
                <table class="checkoutTab" id="tbl">
                    ...
                    foreach ($data as $d) {
                        ...
                        <tr class='cartList'>
                        <input type='hidden' name='BasickSheetRequisition[id][]' value='<?php echo $d->id; ?>' id="BasickSheetRequisition_<?php echo $sl; ?>"/>
                        <input type='hidden' name='BasickSheetRequisition[item][]' value='<?php echo $d->item; ?>'/>
                        ...
                        <td>
                            <input style='text-align: center;' id='width_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[width][]' value='<?php echo $d->width; ?>'/>
                        </td>
                        <td>
                            <input style='text-align: center;' id='height_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[height][]' value='<?php echo $d->height; ?>'/>
                        </td>
                        <td>
                            <input style='text-align: center;' id='thickness_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[thickness][]' value='<?php echo $d->thickness; ?>'/>
                        </td>
                        <td>
                            <select style='text-align: center;width:70px; ' id='unit_of_distance_<?php echo $sl; ?>' myAttr1='unit_of_distance_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[unit_of_distance][]'>
                                <option value="<?php echo $d->unit_of_distance ?>"><?php echo UnitDistance::model()->unit_of_distanceOfThis($d->unit_of_distance); ?></option>
                                <?php
                                $units = UnitDistance::model()->findAll();
                                foreach ($units as $value) :
                                    ?>
                                    <option value="<?php echo $value->id ?>"><?php echo $value->unit_of_distance; ?></option>
                                    <?php
                                endforeach;
                                ?>
                            </select>
                        ...
                        <td>
                            <input style='text-align: center;' id='qtyInpt_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[qty][]' value='<?php echo $d->qty; ?>'/>
                        </td>
                        <td>
                            <select style='text-align: center;width:70px; ' id='unit_of_weight_<?php echo $sl; ?>' myAttr1='unit_of_weight_' myAttr2='<?php echo $sl; ?>' type='text' name='BasickSheetRequisition[unit_of_weight][]'>
                                <option value="<?php echo $d->unit_of_weight ?>"><?php echo Units::model()->name_of_unitOfThis($d->unit_of_weight); ?></option>
                                <?php
            ...
            <div style="float: left; width: 100%;">
                <table>
                    ...
                    <tr>
                        <td><label>Item/Code/Spec.</label></td>
                        <td colspan="8">
            ...
            <div class="rightDiv">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $model->department = end($data)->department;
                            echo $form->dropDownList(
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $model->req_date = end($data)->req_date;
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $model->from_store = end($data)->from_store;
                            echo $form->dropDownList(
                    ...
                    <tr>
                        ...
                        <td><?php $model->remarks = end($data)->remarks;
                        echo $form->textField($model, 'remarks', array('maxlength' => 255, 'class' => 'coloredInput')); ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            ...
                            <?php
                            echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('basickSheetRequisition/update', 'sl_no' => end($data)->sl_no)), array(
                                'dataType' => 'json',
                                'type' => 'post',
                                'success' => 'function(data) {
                                $("#ajaxLoader").hide();  
    ...
    //    var newArr=new Array();
        ...
        $("#tbl td input.rdelete").live("click", function () {
            if (confirm("Are you sure you want to delete this record ? The record will be deleted parmanently.")) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: '<?php echo CController::createUrl('basickSheetRequisition/deleteFromUpdate'); ?>',
                    data: {'id': $("#BasickSheetRequisition_" + idCounter).val()},
                    beforeSend: function () {
        ...
        function add(itemsId, itemsName) {
            ...
            var appendTxt = "<tr class='cartList'>" +
                    "<input type='hidden' name='BasickSheetRequisition[id][]' value='0'>" +
