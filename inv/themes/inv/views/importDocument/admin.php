...
<fieldset style="float: left; width: 98%;">
    <legend>Manage Import Document(s)</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'import-document-grid',
        ...
        'columns' => array(
            array(
                'name'=>'lc_id',
                'value'=>'CHtml::encode(MasterLc::model()->nameOfThis($data->lc_id))',
                'filter'=>CHtml::listData(MasterLc::model()->findAll(array('order' => 'id DESC')), "id", "lc_no"),
            ),
            'pi_no',
            'pi_date',
            array
