...
<div class="formDiv">
    <fieldset>
        <legend>
            <b>MR No:</b> <?php echo $model->sl_no; ?><br/>
            <b>MR Date:</b> <?php echo $model->date; ?><br/>
            <b>Bill No:</b> <?php echo $model->bill_no; ?><br/>
            <b>Customer:</b> <?php echo Customers::model()->customerNameAndAddress($model->customer_id); ?>
        </legend>
        <table>
            <tr>
