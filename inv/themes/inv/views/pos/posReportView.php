...
<div class='printAllTableForThisReport'>
    <div class="grid-view">
        <table class="items">
            <thead>
                <tr>
                    <th colspan="12" style="text-align: center; padding-bottom: 10px; background-color: #ffffff; color: #000000"><?php echo YourCompany::model()->activeInfo(); ?></th>
                </tr>
                <tr>
                    <th colspan="12" style="text-align: center; text-decoration: underline; padding-bottom: 30px; background-color: #ffffff; color: #000000"><?php echo $message; ?></th>
                </tr>
                <tr>
                    <th>SL</th>
                    <th>Category</th>
