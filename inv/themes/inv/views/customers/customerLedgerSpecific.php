...
<div class="search-form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
                'id' => 'customers-form',
                'action' => Yii::app()->createUrl('/customers/customerLedgerSpecificView'),
            ));
    ?>
    <fieldset>
            ...
            <table class="items">
                ...
                <tr style="border: none;">
                    <td colspan="3" style="text-align: left; border: none;">
                        <?php
                        echo CHtml::ajaxSubmitButton('Search', CHtml::normalizeUrl(array('customers/customerLedgerSpecificView', 'render' => true)), array(
                            'dataType' => 'json',
                            'type' => 'post',
                            ...
                            'beforeSend' => 'function(){ 
                                if($("#Customers_startDate").val()=="" || $("#Customers_endDate").val()=="" || $("#Customers_id").val()==""){
                                    alertify.alert("Warning! Please select a date range & customer !");
                                    return false;
                                }else{
                                    $("#ajaxLoader").show();
                                }
...
<fieldset style="float: left; width: 98%;">
    <legend>Specific Customer Ledger<span style=" float: right; margin-left: 8px;"><div id="ajaxLoader" style="display: none;"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ajax-loader.gif" /></div><span></legend>
    <div id="resultDiv">
