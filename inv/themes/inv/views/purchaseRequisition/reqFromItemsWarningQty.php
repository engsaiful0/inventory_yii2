...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->createUrl('/purchaseRequisition/reqFromItemsWarningQtyView'),
        ));
?>
<fieldset>
        ...
        <table class="items">
            ...
            <tr style="border: none;">
                <td colspan="8" style="text-align: left; border: none;">
                    <?php
                    echo CHtml::ajaxSubmitButton('Search', CHtml::normalizeUrl(array('purchaseRequisition/reqFromItemsWarningQtyView', 'render' => true)), array(
                        'dataType' => 'json',
                        'type' => 'post',
