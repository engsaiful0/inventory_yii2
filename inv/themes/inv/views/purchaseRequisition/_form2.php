...
if ($data) {
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => $this->createUrl('purchaseRequisition/update'),
        'enableAjaxValidation' => false,
        'enableClientValidation' => true,
        'clientOptions' => array('validateOnSubmit' => true),
    ));
    ?>
    <input type="hidden" name="PurchaseRequisition[created_time]" value="<?php echo end($data)->created_time; ?>"/>
    <input type="hidden" name="PurchaseRequisition[created_by]" value="<?php echo end($data)->created_by; ?>"/>
    <input type="hidden" name="PurchaseRequisition[sl_no]" value="<?php echo end($data)->sl_no; ?>"/>
    <input type="hidden" name="PurchaseRequisition[max_sl_no]" value="<?php echo end($data)->max_sl_no; ?>"/>
    <div class="formDiv">
        <fieldset>
            <legend>Purchase Requisition Update Form</legend>
            <div class="scrollable">
                <table class="checkoutTab" id="tbl">
                    ...
                    foreach ($data as $d) {
                        ...
                        <tr class='cartList'>
                        <input type='hidden' name='PurchaseRequisition[id][]' value='<?php echo $d->id; ?>' id="PurchaseRequisition_<?php echo $sl; ?>"/>
                        <input type='hidden' name='PurchaseRequisition[item][]' value='<?php echo $d->item; ?>'/>
                        ...
                        <td>
                            <input style='text-align: center;' id='qtyInpt_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='PurchaseRequisition[qty][]' value='<?php echo $d->qty; ?>'/>
                        </td>
                        <td>
                            <select style='text-align: center;width:70px; ' id='name_of_unit_<?php echo $sl; ?>' myAttr1='name_of_unit_' myAttr2='<?php echo $sl; ?>' type='text' name='PurchaseRequisition[name_of_unit][]'>
                        ...
                        <td>
                            <input style='text-align: center;' id='priceInpt_<?php echo $sl; ?>' myAttr1='priceInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='PurchaseRequisition[cost][]' value='<?php echo $d->cost; ?>'/>
                        </td>
                        <?php
                        $amount = $d->qty * $d->cost;
                        ...
                        <td>
                            <input type='text' name='PurchaseRequisition[remarks][]' value="<?php echo $d->remarks; ?>"/>
                        </td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('purchaseRequisition/update', 'sl_no' => end($data)->sl_no)), array(
                                'dataType' => 'json',
                                'type' => 'post',
                                'success' => 'function(data) {
                                $("#ajaxLoader").hide();  
    ...
    $(document).ready(function () {
        ...
        $("#tbl td input.rdelete").live("click", function () {
            if (confirm("Are you sure you want to delete this record ? The record will be deleted parmanently.")) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: '<?php echo CController::createUrl('purchaseRequisition/deleteFromUpdate'); ?>',
                    data: {'id': $("#PurchaseRequisition_" + idCounter).val()},
                    beforeSend: function () {
        ...
        function add(itemsId, itemsName, itemCost) {
            ...
            var appendTxt = "<tr class='cartList'>" +
                    "<input type='hidden' name='PurchaseRequisition[id][]' value='0'>" +
