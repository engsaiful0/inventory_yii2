<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('from_temp_store')); ?>:</b>
	<?php echo CHtml::encode($data->from_temp_store); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('to_main_store')); ?>:</b>
	<?php echo CHtml::encode($data->to_main_store); ?>
	<br />
