...
");
?>
<?php echo CHtml::link('Manage Costing Prices', array('/costingPrice/admin'), array('class'=>'additionalBtn')); ?>
<fieldset style="float: left; width: 98%;">
    ...
    $this->widget('ext.groupgridview.GroupGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'name' => 'activeCostinglPrice',
                'value' => 'CostingPrice::model()->activeCostingPrice($data->id)',
                'filter' => '',
            ...
            array(
                ...
                'buttons' => array(
                    'costingPriceHistory' => array(
                         'label'=>'Costing Price History',
                        'imageUrl' => Yii::app()->theme->baseUrl . '/images/history.ico',
                        'url' => 'Yii::app()->controller->createUrl("costingPrice/priceHistory",array("item"=>$data->id))',
                        'click' => "function(){
