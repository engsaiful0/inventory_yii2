...
$form = $this->beginWidget('CActiveForm', array(
            'id' => 'pmodel-form',
            'action' => $this->createUrl('pModel/create'),
...
<div class="formDiv">
    <fieldset>
        <legend><?php echo ($model->isNewRecord ? 'Add New Model' : 'Update Model'); ?></legend>
        <table>
            <tr>
    ...
    <fieldset class="tblFooters">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('pModel/create', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
            'success' => 'function(data) {
                $("#ajaxLoader").hide();  
                    if(data.status=="success"){
                        ...
                        $.fn.yiiGridView.update("pmodel-grid", {
                            data: $(this).serialize()
                        });
                    }else{
                        $("#formResult").hide();
                        ...
                        $.each(data, function(key, val) {
                            $("#pmodel-form #"+key+"_em_").html(""+val+"");                                                    
                            $("#pmodel-form #"+key+"_em_").show();
                        });
                    }       
                }',
            'beforeSend' => 'function(){                        
