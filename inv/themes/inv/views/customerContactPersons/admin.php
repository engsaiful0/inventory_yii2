...
<?php } ?>
<?php echo CHtml::link('Back To Customers', array('/customers/admin'), array('class'=>'additionalBtn')); ?>
<fieldset style="float: left; width: 98%;">
    <legend>Manage Contact Persons (Customer's)</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'customer-contact-persons-grid',
        ...
        'columns' => array(
            array(
                'name'=>'company_id',
                'value'=>'CHtml::encode(Customers::model()->customerName($data->company_id))',
                'filter'=>CHtml::listData(Customers::model()->findAll(array('order' => 'id DESC')), "id", "company_name"),
            ),
            'contact_person_name',
            array(
                'name' => 'designation_id',
