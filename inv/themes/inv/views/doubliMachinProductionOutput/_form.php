    ...
    <?php foreach ($data as $d) { ?>
                        <tr class='cartList'>
                            <td class='sno' style='text-align: center;'>
                                <input type='hidden' name='DoubliMachinProductionInput[id][]' value='<?php echo $d->id; ?>'/>
        <?php echo $sl; ?> 
                            </td>
                            ...
                            echo CHtml::submitButton('Search Items', array(
                                'ajax' => array(
                                    ...
                                    'data' => array(
                                        ...
                                        'formName' => 'DoubliMachinProductionOuput',
                                    ),
                                    'beforeSend' => 'function(){
...
$('.ajaxLoaderFormLoad').hide();
        ...
        'success' => "function(data){
                                ...
                                {
                                    $('#DoubliMachinProductionOuput_item').append('<option selected value='+data.value+'>'+data.label+'</option>');
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".itms").click(function () {
                ...
                $("#DoubliMachinProductionOuput_item").val(itemsId);
                $("#DoubliMachinProductionOuput_qty").val(1);
            });
        })
    </script>
    <?php
} else {
    $this->redirect(array('/doubliMachinProductionOutput/adminOutput'));
}
?>
