<?php
$data = SaleOrder::model()->findAll(array("condition" => "sl_no='" . $sl_no . "'"));
if ($data) {
    ?>
<?php
$form = $this->beginWidget('CActiveForm', array(
            'id' => 'sale-order-form',
            'action' => $this->createUrl('saleOrder/update'),
...
?>
<input type="hidden" name="SaleOrder[created_time]" value="<?php echo end($data)->created_time; ?>"/>
<input type="hidden" name="SaleOrder[created_by]" value="<?php echo end($data)->created_by; ?>"/>
<input type="hidden" name="SaleOrder[sl_no]" value="<?php echo end($data)->sl_no; ?>"/>
<input type="hidden" name="SaleOrder[max_sl_no]" value="<?php echo end($data)->max_sl_no; ?>"/>
<div class="formDiv">
    <fieldset>
        <legend>Sale Order Update Form</legend>
...
//            $sqm=0;
            ...
            ?>
                        ...
                        <tr class='cartList'>
                            <input type='hidden' name='SaleOrder[id][]' value='<?php echo $d->id; ?>' id="SaleOrder_<?php echo $sl; ?>"/>
                            <input type='hidden' name='SaleOrder[item][]' value='<?php echo $d->item; ?>'/>
                            <td class='sno' style='text-align: center;'>
                                <?php echo $sl; ?>
                            </td>
                            <td style='text-align: left; padding-left:2px;'>
                                <?php Items::model()->item($d->item); ?>
                            </td>
                            <td>
                                <input style='text-align: center;' id='qtyInpt_<?php echo $sl; ?>' myAttr1='qtyInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='SaleOrder[qty][]' value='<?php echo $d->qty; ?>'/>
                            </td>
                            <td>
                               
                                <?php
                                $model->conv_unit=$d->conv_unit;
                                    echo $form->dropDownList(
                                            $model, 'conv_unit[]', array('1'=>'SFT', '2'=>'RFT', '3'=>'CFT', '4'=>'SQM'), array(
                                        'prompt' => 'Select',
                                                'id'=>'unitSelect_'.$sl
                                    ));
                                ?>
                            ...
                            <td>
                                <span id='convertedText_<?php echo $sl; ?>'><?php echo $convertedText; ?></span>
                            </td>
                            <td>
                                <input style='text-align: center;' id='priceInpt_<?php echo $sl; ?>' myAttr1='priceInpt_' myAttr2='<?php echo $sl; ?>' type='text' name='SaleOrder[price][]' value='<?php echo $d->price; ?>'/>
                            </td>
                            <td>
                                <input style='text-align: center;' id='lineTtlInpt_<?php echo $sl; ?>' class='lineTotalInpt' type='text' value='<?php echo $amount; ?>'/>
                            </td>
                        ...
                        <script>
                            $(document).ready(function(){
                                ...
                                calFnc(<?php echo $sl; ?>, '<?php echo $sft; ?>', <?php echo $rft; ?>, '<?php echo $cft; ?>', '<?php echo $sqm; ?>');
        ...
        <div class="rightDiv" style="height: 470px;">
            <table>
                ...
                <tr>
                    ...
                    <td><?php $model->subj=end($data)->subj; echo $form->textField($model, 'subj', array('maxlength' => 255, 'class' => 'coloredInput')); ?></td>
                </tr>
                <tr>
                    <td style="text-align: right; padding-right: 6px;"><?php echo $form->labelEx($model, 'issue_date'); ?></td>
                    <td>
                        <?php
                        $model->issue_date=end($data)->issue_date;
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $model->expected_d_date=end($data)->expected_d_date;
                        Yii::import('application.extensions.CJuiDateTimePicker.CJuiDateTimePicker');
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $model->order_type2=end($data)->order_type2;
                        echo $form->dropDownList(
                ...
                <tr>
                    ...
                    <td><?php $model->pi_no=end($data)->pi_no; echo $form->textField($model, 'pi_no', array('maxlength' => 255, 'class' => 'coloredInput')); ?></td>
                </tr>
                <tr>
                    <td style="text-align: right; padding-right: 6px;"><?php echo $form->labelEx($model, 'pi_date'); ?></td>
                    <td>
                        <?php
                        $model->pi_date=end($data)->pi_date;
                        Yii::import('application.extensions.CJuiDateTimePicker.CJuiDateTimePicker');
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $model->customer_id=end($data)->customer_id;
                        echo $form->dropDownList(
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $model->contact_person=end($data)->contact_person;
                        echo $form->dropDownList(
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $model->sales_by=end($data)->sales_by;
                        echo $form->dropDownList(
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('saleOrder/update', 'sl_no' => end($data)->sl_no)), array(
                            'dataType' => 'json',
                            'type' => 'post',
                            'success' => 'function(data) {
                                errQtyArr.length=0;
...
//    var newArr=new Array();
        ...
        if($("#Items_id").val()==""){
            ...
            if($.inArray(itemsId, newArr) > -1){
                ...
                if(selectedValue==sftVal){
                    tempQty=sft;
                    $("#convertedText_"+positionOfArrVal).html(sft+"SFT");
                }else if(selectedValue==rftVal){
                    tempQty=rft;
                    $("#convertedText_"+positionOfArrVal).html(rft+"RFT");
    ...
    function calFnc(count, sft, rft, cft, sqm){ 
        $("#unitSelect_"+count).change(function(){
            ...
            if(selectedValue==sftVal){
                sellQnty=sft;
                $("#convertedText_"+count).html(sft+" SFT");
            }else if(selectedValue==rftVal){
                sellQnty=rft;
                $("#convertedText_"+count).html(rft+" RFT");
            }else if(selectedValue==cftVal){
