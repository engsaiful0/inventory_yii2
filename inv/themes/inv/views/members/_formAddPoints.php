...
<div class="formDiv">
    <fieldset>
        <legend>Add Member Points</legend>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $form->textField($model, 'inv_no', array('maxlength' => 255, 'class'=>'optionalInputsForPos')); ?></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td><?php echo $form->labelEx($model, 'added_point'); ?></td>
                <td><?php echo $form->textField($model, 'added_point', array('class'=>'optionalInputsForPos')); ?></td>
            </tr>
            <tr>
                <td></td>
                <td><?php echo $form->error($model, 'added_point'); ?></td>
            </tr>
            <tr>
