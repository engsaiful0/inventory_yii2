...
?>
<?php
echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/xls.png"), array('/reportXsl/supplierLedgerAllExcel',
    'startDate' => $startDate,
    'endDate' => $endDate,), array('title' => 'Export as xls'));
?>
<?php
echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/pdf.png"), array('/reportPdf/supplierLedgerAllPdf',
    'startDate' => $startDate,
        ...
        <table class="items">
            ...
            <tbody>
                ...
                if ($data) {
                    ...
                    $totalDueTotal = 0;
                    foreach ($data as $d) {
                        $totalReceived = PurchaseRcvRtn::model()->totalRcvAmount($supplier_id=$d->id, $date=null, $startDate=$startDate, $endDate=$endDate);
                        $totalPaid = 0;
                        $totalDiscount = 0;
