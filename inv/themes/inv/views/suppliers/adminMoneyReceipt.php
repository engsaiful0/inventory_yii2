    ...
    $this->widget('ext.groupgridview.GroupGridView', array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'value' => 'Suppliers::model()->transactionInfo($data->po_id)',
                'filter' => '',
            ...
            array
                ...
                'buttons' => array(
                    'moneyReceiptHistory' => array(
                        ...
                        'url' => 'Yii::app()->controller->createUrl("supplierMr/moneyReceiptHistory",array("supplier_id"=>$data->id))',
                        'click' => "function(){
                    ...
                    'addMoneyReceipt' => array(
                        ...
                        'url' => 'Yii::app()->controller->createUrl("supplierMr/addMoneyReceipt",array("po_id"=>$data->po_id))',
                        'click' => "function( e ){
                                e.preventDefault();
