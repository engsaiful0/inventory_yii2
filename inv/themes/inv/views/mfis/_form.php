...
$form = $this->beginWidget('CActiveForm', array(
            'id' => 'mfis-form',
            'action' => $this->createUrl('mfis/create'),
...
<div class="formDiv">
    ...
    <fieldset class="tblFooters">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('mfis/create', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
            'success' => 'function(data) {
                $("#ajaxLoader").hide();  
                    if(data.status=="success"){
                        ...
                        $.fn.yiiGridView.update("mfis-grid", {
                            data: $(this).serialize()
                        });
                    }else{
                        $("#formResult").hide();
                        ...
                        $.each(data, function(key, val) {
                            $("#mfis-form #"+key+"_em_").html(""+val+"");                                                    
                            $("#mfis-form #"+key+"_em_").show();
                        });
                    }       
                }',
            'beforeSend' => 'function(){                        
