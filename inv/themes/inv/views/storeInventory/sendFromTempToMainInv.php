...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->createUrl('/storeInventory/sendFromTempToMainInvView'),
        ));
?>
<fieldset>
        ...
        <table class="items">
            ...
            <tr style="border: none;">
                <td colspan="6" style="text-align: left; border: none;">
                    <?php
                    echo CHtml::ajaxSubmitButton('Search', CHtml::normalizeUrl(array('storeInventory/sendFromTempToMainInvView', 'render' => true)), array(
                        'dataType' => 'json',
                        'type' => 'post',
                        'success' => 'function(data) {
                            $("#ajaxLoader").hide(); 
