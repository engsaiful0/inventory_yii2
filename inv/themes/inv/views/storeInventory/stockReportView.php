...
?>
<?php
echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/xls.png"), array('/reportXsl/stockReportStoreExcel',
    'startDate' => $startDate,
    'endDate' => $endDate,
    'store' => $store,
    'category' => $category,
...
?>
<?php
echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/pdf.png"), array('/reportPdf/stockReportStorePdf',
    'startDate' => $startDate,
    'endDate' => $endDate,
    'store' => $store,
    'category' => $category,
            ...
            <tbody>
                <?php if ($data) { ?>
                    ...
                    foreach ($data as $d):
                        ...
                        $dataOpeningStock = StoreInventory::model()->findAll($cirteriaOpeningStock);
