...
<div class="search-form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('/storeInventory/stockReportView'),
            ));
    ?>
    <fieldset>
            ...
            <table class="items">
                                    ...
                                    $model, 'category', CHtml::listData(Cats::model()->findAll(array("order"=>"name ASC")), 'id', 'name'), array(
                                        ...
                                        'ajax' => array(
                                            ...
                                            'success' => 'function(data) {
                                                    $("#StoreInventory_item").html(data.items);
                                             }',
                                            'data' => array(
                                                'catId' => 'js:jQuery("#StoreInventory_category").val()',
                                            ),
                                            'beforeSend' => 'function(){
                                                document.getElementById("StoreInventory_item").style.background="url(' . Yii::app()->theme->baseUrl . '/images/ajax-loader.gif) no-repeat #FFFFFF 98% 2px";   
                                             }',
                                            'complete' => 'function(){
                                                document.getElementById("StoreInventory_item").style.background="url(' . Yii::app()->theme->baseUrl . '/images/downDrop.png) no-repeat #FFFFFF 98% 2px";
                                            }',
                                        ),
                            ));
                        ?>
                    ...
                    <td>
                        ...
                        echo $form->dropDownList(
                            ...
                            'ajax' => array(
                                ...
                                'data' => array(
                                    'catId' => 'js:jQuery("#StoreInventory_category").val()',
                                    'supplierId' => 'js:jQuery("#StoreInventory_supplier_id").val()',
                                ),
                                'beforeSend' => 'function(){
                                            document.getElementById("StoreInventory_item").style.background="url(' . Yii::app()->theme->baseUrl . '/images/ajax-loader.gif) no-repeat #FFFFFF 98% 2px";   
                                         }',
                ...
                <tr style="border: none;">
                    <td colspan="3" style="text-align: left; border: none;">
                        <?php
                        echo CHtml::ajaxSubmitButton('Search', CHtml::normalizeUrl(array('storeInventory/stockReportView', 'render' => true)), array(
                            'dataType' => 'json',
                            'type' => 'post',
                            'success' => 'function(data) {
                                $("#ajaxLoader").hide(); 
                            ...
                            'beforeSend' => 'function(){ 
                                if($("#StoreInventory_startDate").val()=="" || $("#StoreInventory_endDate").val()==""){
...
<fieldset style="float: left; width: 98%;">
    <legend>Stock (Temporary Inventory) Report <span style=" float: right; margin-left: 8px;"><div id="ajaxLoader" style="display: none;"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ajax-loader.gif" /></div><span></legend>
    <div id="resultDiv">
