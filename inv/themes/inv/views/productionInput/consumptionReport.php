...
<div class="search-form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('/productionInput/consumptionReportView'),
            ));
    ?>
    <fieldset>
            ...
            <table class="items">
                ...
                <tr style="border: none;">
                    <td colspan="4" style="text-align: left; border: none;">
                        <?php
                        echo CHtml::ajaxSubmitButton('Search', CHtml::normalizeUrl(array('productionInput/consumptionReportView', 'render' => true)), array(
                            'dataType' => 'json',
                            'type' => 'post',
                            'success' => 'function(data) {
                                $("#ajaxLoader").hide(); 
...
<fieldset style="float: left; width: 98%;">
    <legend>Consumption Report <span style=" float: right; margin-left: 8px;"><div id="ajaxLoader" style="display: none;"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ajax-loader.gif" /></div><span></legend>
    <div id="resultDiv">
