...
$form = $this->beginWidget('CActiveForm', array(
            'id' => 'banks-form',
            'action' => $this->createUrl('banks/create'),
...
<div class="formDiv">
    ...
    <fieldset class="tblFooters">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('banks/create', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
            'success' => 'function(data) {
                $("#ajaxLoader").hide();  
                    if(data.status=="success"){
                        ...
                        $.fn.yiiGridView.update("banks-grid", {
		data: $(this).serialize()
	});
                    }else{
                        $("#formResult").hide();
                        ...
                        $.each(data, function(key, val) {
                            $("#banks-form #"+key+"_em_").html(""+val+"");                                                    
                            $("#banks-form #"+key+"_em_").show();
                        });
                    }       
                }',
            'beforeSend' => 'function(){                        
