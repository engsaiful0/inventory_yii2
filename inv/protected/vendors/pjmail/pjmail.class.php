...
if (!defined('__CLASS_PJ_MAIL__'))
{
	...
	class PJmail extends simplemail
	{
		...
		*/
		...
		/**
		* attacher un fichier binaire en pi�ce jointe
		* 
		...
		*/
		function writeattachement(&$attachement,$B)
		{
			...
			if ( !empty($attachement) )
			{
				foreach($attachement as $AttmFile)
				{
					...
					// ****************************************************
					// Modification pour r�cup�rer la source dans le tableau si elle est renseigner
		...
		/**
		* surcharge de la fonction d'origine de simplemail afin d'annuler le retour � la ligne automatique
		* 
