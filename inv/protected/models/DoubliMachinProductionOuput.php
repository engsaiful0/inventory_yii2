...
class DoubliMachinProductionOuput extends CActiveRecord {
    ...
    public function tableName() {
        return 'doubli_machin_production_output';
    }
    ...
    public function rules() {
        ...
        return array(
            array('date, time, item, qty, qty_kg,unit_of_distance,length,width,thickness', 'required'),
            array('max_sl_no, item, created_by, updated_by', 'numerical', 'integerOnly' => true),
            array('qty, qty_kg,length,width,thickness', 'numerical'),
