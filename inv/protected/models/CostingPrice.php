...
class CostingPrice extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return CostingPrice the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            ...
            array('item, created_by, updated_by, is_active', 'numerical', 'integerOnly' => true),
            array('price', 'numerical'),
            array('date, created_time, updated_time', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, item, price, date, created_by, created_time, updated_by, updated_time, is_active', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function activeCostingPrice($item_id) {
        $price = 0;
