...
class BasickSheetRequisition extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return BasickSheetRequisition the static model class
     */
    ...
    public function rules() {
        ...
        return array(
            ...
            array('qty,width,height,thickness', 'numerical'),
    ...
    public function update($sl_no) {
        echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . '/images/editBtnBg.png'), array('/basickSheetRequisition/update', 'sl_no' => $sl_no));
    }
    
    public function delete($sl_no) {
        echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . '/images/deleteBtnBg.png'), array('/basickSheetRequisition/delete', 'sl_no' => $sl_no));
    }
