...
class SupplierContactPersonsController extends Controller {
    ...
    public function actionContacts($company_id){
        ...
        $data = SupplierContactPersons::model()->findAll(array('condition' => $condition,), 'id');
     ...
     public function actionAddContactPerson($company_id) {
        ...
        $model = new SupplierContactPersons();

        // Uncomment the following line if AJAX validation is needed
        $this->performAjaxValidation($model);

        if (isset($_POST['SupplierContactPersons'])) {
            $model->attributes = $_POST['SupplierContactPersons'];
            if ($model->save()) {
    ...
    public function actionAdmin() {
        $model = new SupplierContactPersons('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['SupplierContactPersons']))
            $model->attributes = $_GET['SupplierContactPersons'];
    ...
    public function loadModel($id) {
        $model = SupplierContactPersons::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'supplier-contact-persons-form') {
