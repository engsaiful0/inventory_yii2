...
class DepartmentsController extends Controller {
     ...
     */
    public function actionCreateDepartmentFromOutSide() {
        ...
        if (isset($_POST['Departments'])) {
            ...
            if ($model->save()) {
                if (Yii::app()->request->isAjaxRequest) {
                    $data = Departments::model()->findByPk($model->id);
                    echo CJSON::encode(array(
                        'status' => 'success',
                        'div' => "<div class='flash-notice'>New Department successfully added</div>",
                        'value' => $data->id,
