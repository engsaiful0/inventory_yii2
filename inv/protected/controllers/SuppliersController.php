...
class SuppliersController extends Controller {
    ...
    public function actionSupplierLedgerAll(){
        $model = new Suppliers;

        $this->render('supplierLedgerAll', array(
            'model' => $model,
        ));
    }
    
    public function actionSupplierLedgerAllView(){
        $startDate = $_POST['Suppliers']['startDate'];
        $endDate = $_POST['Suppliers']['endDate'];
        ...
        echo CJSON::encode(array(
            'content' => $this->renderPartial('supplierLedgerAllView', array(
                'data' => $data,
                'message' => $message,
                'startDate' => $startDate,
                'endDate' => $endDate,
    ...
    public function actionSupplierLedgerSpecific(){
        $model = new Suppliers;

        $this->render('supplierLedgerSpecific', array(
            'model' => $model,
        ));
    }
    
    public function actionSupplierLedgerSpecificView(){
        $startDate = $_POST['Suppliers']['startDate'];
        $endDate = $_POST['Suppliers']['endDate'];
        $id = $_POST['Suppliers']['id'];
        ...
        if ($startDate != "" && $endDate != "" && $id!="") {
            ...
            $message = "<div class='flash-error'>Please select date range & supplier !</div>";
        }
        
        echo CJSON::encode(array(
            'content' => $this->renderPartial('supplierLedgerSpecificView', array(
                'message' => $message,
                'startDate' => $startDate,
                'endDate' => $endDate,
                'id'=>$id,
        ...
        if (isset($_POST['Suppliers'])) {
            ...
            if ($model->save()) {
                if (Yii::app()->request->isAjaxRequest) {
                    ...
                    echo CJSON::encode(array(
                        'status' => 'success',
                        'div' => "<div class='flash-notice'>New Supplier successfully added</div>",
                        'value' => $data->id,
    ...
    public function actionAdmin() {
        ...
        public function actionAdminMoneyReceipt(){
         $model = new PurchaseRcvRtn('searchForPORcv');
        $model->unsetAttributes();  // clear any default values
