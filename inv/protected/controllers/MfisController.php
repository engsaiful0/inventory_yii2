...
class MfisController extends Controller {
    ...
    public function actionCreateMfisFromOutSide() {
        $model = new Mfis;
        ...
        if (isset($_POST['Mfis'])) {
            $model->attributes = $_POST['Mfis'];
            if ($model->save()) {
                if (Yii::app()->request->isAjaxRequest) {
                    $data = Mfis::model()->findByPk($model->id);
    ...
    public function actionAdmin() {
        $model = new Mfis('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Mfis']))
            $model->attributes = $_GET['Mfis'];
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'mfis-form') {
