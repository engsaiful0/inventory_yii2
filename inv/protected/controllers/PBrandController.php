...
class PBrandController extends Controller {
    ...
    public function actionCreatePBrandFromOutSide() {
        $model = new PBrand;
        ...
        if (isset($_POST['PBrand'])) {
            $model->attributes = $_POST['PBrand'];
            if ($model->save()) {
                if (Yii::app()->request->isAjaxRequest) {
                    $data = PBrand::model()->findByPk($model->id);
    ...
    public function actionAdmin() {
        $model = new PBrand('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['PBrand']))
            $model->attributes = $_GET['PBrand'];
    ...
    public function loadModel($id) {
        $model = PBrand::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'pbrand-form') {
